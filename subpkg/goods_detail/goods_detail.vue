<template>
    <view v-if="goods_info.goods_name" class="goods-detail-container">
        <!-- 轮播图区域 -->
        <swiper indicator-dots autoplay circular interval="3000" duration="400">
            <swiper-item v-for="(item, i) in goods_info.pics" :key="i">
                <!-- 把当前点击的图片的索引，传递到preview()处理函数中 -->
    ...
    export default {
        ...
        methods: {
            ...
            async getGoodsDetail(goods_id) {
                ...
                // 使用字符串的replace()方法，将webp的后缀名替换为jpg的后缀名
...
<style lang="scss">
    ...
    .goods-detail-container {
        // 给页面外层的容器，添加75px的内padding，防止页面内容被底部的商品导航组件遮盖
        padding-bottom: 75px;
    }
</style>